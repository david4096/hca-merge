...
setup(
    name="hca-merge",
    description="Merges data in a HCA study to provide a single file.",
    packages=["hcamerge"],
    namespace_packages=[],
    zip_safe=False,
    url="https://github.com/david4096/hca-merge",
    version=1.0,
    entry_points={
        'console_scripts': ['hca-merge=hcamerge.hcamerge:main']
    },
